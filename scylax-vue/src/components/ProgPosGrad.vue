            ...
            <v-col>
                <v-card v-if="canRender" width="100%">
                    <v-container>
                        <v-row>
                            <v-col>
                                <iframe :src="cluster_scores" height="400" width="100%" frameBorder="0"></iframe>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col>

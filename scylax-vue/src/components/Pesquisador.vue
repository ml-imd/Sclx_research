                ...
                <v-card v-if="canRender" width="100%" color="#fafbfd">
                    <div class="text-end" style="background-color : #424C63">
                        <v-tooltip bottom color="white">
                            ...
                            <span style="color:black">Para exibir informações sobre um pesquisador, digite seu nome e clique em analisar pesquisador.</span>
                        </v-tooltip>
                    </div>
